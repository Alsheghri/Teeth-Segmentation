...
# Reproducibility
    ...
    train_list = './train_list_3.csv' # use 1-fold as example
    val_list = './val_list_3.csv' # use 1-fold as example

    KNN_ROOT = './clustered/'


    model_path = '/home/ammar15/scratch/fewShotnonperfectUpper4k14/models/'
    model_name = 'Mesh_Segementation_MeshSegNet_15_classes_4samples_Upper_missingTooth_K14' # need to define
    ...
    SELFSUP_DATASET = KNNSelfSupDataset(root=KNN_ROOT, num_classes=15, patch_size=9000,
                                        npoints=200,
                                        class_choice=None,
...
# set model
    ...
    for epoch in range(num_epochs):
        ...
        stat.to_csv(r'/home/ammar15/scratch/fewShotnonperfectUpper4k14/losses_metrics_vs_epoch.csv')