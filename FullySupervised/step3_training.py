...
if __name__ == '__main__':
    ...
    model_path = '/home/ammar15/scratch/supervisedUpperArchesMissingTeeth_4/models/'
    model_name = 'MeshSegNet_15classes_Upper4_missingTooth_Narval' # need to define
    checkpoint_name = 'latest_checkpoint_Fold3.tar'
    ...
    for epoch in range(num_epochs):
        ...
        stat.to_csv(r'/home/ammar15/scratch/supervisedUpperArchesMissingTeeth_4/losses_metrics_vs_epoch.csv')